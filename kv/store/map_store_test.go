...
func TestNewMapStoreWithOptions(t *testing.T) {
	Convey("NewMapStoreWithOptions", t, func() {
		Convey("创建基本MapStore", func() {
			store := NewMapStoreWithOptions[string, string]()
		...
		Convey("支持不同数据类型", func() {
			Convey("int类型值", func() {
				store := NewMapStoreWithOptions[string, int]()
				So(store, ShouldNotBeNil)
				defer store.Close()
			})

			Convey("int类型键", func() {
				store := NewMapStoreWithOptions[int, string]()
				So(store, ShouldNotBeNil)
				defer store.Close()
			})
		})
...
func TestMapStoreGet(t *testing.T) {
	Convey("MapStore.Get", t, func() {
		...
		Convey("不同数据类型", func() {
			Convey("int类型值", func() {
				intStore := NewMapStoreWithOptions[string, int]()
...
func TestMapStoreDel(t *testing.T) {
	Convey("MapStore.Del", t, func() {
		store := NewMapStoreWithOptions[string, string]()
		defer store.Close()
...
func TestMapStoreBatchSet(t *testing.T) {
	Convey("MapStore.BatchSet", t, func() {
		store := NewMapStoreWithOptions[string, string]()
		defer store.Close()
...
func TestMapStoreBatchGet(t *testing.T) {
	Convey("MapStore.BatchGet", t, func() {
		store := NewMapStoreWithOptions[string, string]()
		defer store.Close()
...
func TestMapStoreBatchDel(t *testing.T) {
	Convey("MapStore.BatchDel", t, func() {
		store := NewMapStoreWithOptions[string, string]()
		defer store.Close()
...
func TestMapStoreClose(t *testing.T) {
	Convey("MapStore.Close", t, func() {
		store := NewMapStoreWithOptions[string, string]()
