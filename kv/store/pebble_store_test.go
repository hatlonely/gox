...
func TestNewPebbleStoreWithOptions(t *testing.T) {
	Convey("NewPebbleStoreWithOptions", t, func() {
		Convey("使用默认配置创建", func() {
			...
			store, err := NewPebbleStoreWithOptions[string, string](options)
			So(err, ShouldBeNil)
		...
		Convey("支持不同数据类型", func() {
			Convey("int类型值", func() {
				...
				store, err := NewPebbleStoreWithOptions[string, int](options)
				So(err, ShouldBeNil)
				So(store, ShouldNotBeNil)
				defer store.Close()
			})
			...
			Convey("int类型键", func() {
				...
				store, err := NewPebbleStoreWithOptions[int, string](options)
				So(err, ShouldBeNil)
				So(store, ShouldNotBeNil)
				defer store.Close()
			})
...
func TestPebbleStoreGet(t *testing.T) {
	Convey("PebbleStore.Get", t, func() {
		tempDir, err := os.MkdirTemp("", "pebble_test_*")
		So(err, ShouldBeNil)
		defer os.RemoveAll(tempDir)
		...
		Convey("不同数据类型", func() {
			Convey("int类型值", func() {
				tempDir2, err := os.MkdirTemp("", "pebble_test_*")
				So(err, ShouldBeNil)
				...
				intStore, err := NewPebbleStoreWithOptions[string, int](options)
				So(err, ShouldBeNil)
...
func TestPebbleStoreDel(t *testing.T) {
	Convey("PebbleStore.Del", t, func() {
		tempDir, err := os.MkdirTemp("", "pebble_test_*")
		So(err, ShouldBeNil)
		defer os.RemoveAll(tempDir)
...
func TestPebbleStoreBatchSet(t *testing.T) {
	Convey("PebbleStore.BatchSet", t, func() {
		tempDir, err := os.MkdirTemp("", "pebble_test_*")
		So(err, ShouldBeNil)
		defer os.RemoveAll(tempDir)
...
func TestPebbleStoreBatchGet(t *testing.T) {
	Convey("PebbleStore.BatchGet", t, func() {
		tempDir, err := os.MkdirTemp("", "pebble_test_*")
		So(err, ShouldBeNil)
		defer os.RemoveAll(tempDir)
...
func TestPebbleStoreBatchDel(t *testing.T) {
	Convey("PebbleStore.BatchDel", t, func() {
		tempDir, err := os.MkdirTemp("", "pebble_test_*")
		So(err, ShouldBeNil)
		defer os.RemoveAll(tempDir)
...
func TestPebbleStoreClose(t *testing.T) {
	Convey("PebbleStore.Close", t, func() {
		Convey("正常关闭", func() {
			tempDir, err := os.MkdirTemp("", "pebble_test_*")
			So(err, ShouldBeNil)
			defer os.RemoveAll(tempDir)
