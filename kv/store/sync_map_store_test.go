...
func TestNewSyncMapStoreWithOptions(t *testing.T) {
	Convey("NewSyncMapStoreWithOptions", t, func() {
		Convey("创建基本SyncMapStore", func() {
			store := NewSyncMapStoreWithOptions[string, string]()
		...
		Convey("支持不同数据类型", func() {
			Convey("int类型值", func() {
				store := NewSyncMapStoreWithOptions[string, int]()
				So(store, ShouldNotBeNil)
				defer store.Close()
			})

			Convey("int类型键", func() {
				store := NewSyncMapStoreWithOptions[int, string]()
				So(store, ShouldNotBeNil)
				defer store.Close()
			})
		})
...
func TestSyncMapStoreSet(t *testing.T) {
	Convey("SyncMapStore.Set", t, func() {
		store := NewSyncMapStoreWithOptions[string, string]()
		defer store.Close()
...
func TestSyncMapStoreGet(t *testing.T) {
	Convey("SyncMapStore.Get", t, func() {
		store := NewSyncMapStoreWithOptions[string, string]()
		defer store.Close()
		...
		Convey("不同数据类型", func() {
			Convey("int类型值", func() {
				intStore := NewSyncMapStoreWithOptions[string, int]()
...
func TestSyncMapStoreDel(t *testing.T) {
	Convey("SyncMapStore.Del", t, func() {
		store := NewSyncMapStoreWithOptions[string, string]()
		defer store.Close()
...
func TestSyncMapStoreBatchSet(t *testing.T) {
	Convey("SyncMapStore.BatchSet", t, func() {
		store := NewSyncMapStoreWithOptions[string, string]()
		defer store.Close()
...
func TestSyncMapStoreBatchGet(t *testing.T) {
	Convey("SyncMapStore.BatchGet", t, func() {
		store := NewSyncMapStoreWithOptions[string, string]()
		defer store.Close()
...
func TestSyncMapStoreBatchDel(t *testing.T) {
	Convey("SyncMapStore.BatchDel", t, func() {
		store := NewSyncMapStoreWithOptions[string, string]()
		defer store.Close()
...
func TestSyncMapStoreClose(t *testing.T) {
	Convey("SyncMapStore.Close", t, func() {
		store := NewSyncMapStoreWithOptions[string, string]()
