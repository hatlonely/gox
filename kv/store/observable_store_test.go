	...
	Convey("NewObservableStoreWithOptions", t, func() {
		...
		Convey("创建带Logger的ObservableStore", func() {
			options := &ObservableStoreOptions{
				...
				Name:          randomName("test_store_with_logger"),
				EnableMetrics: true,
				EnableLogging: true,
				EnableTracing: false,
			}
	...
	Convey("ObservableStore.Set", t, func() {
		Convey("基本设置操作", func() {
			options := &ObservableStoreOptions{
				...
				Name:          randomName("test_store_set_basic"),
				EnableMetrics: true,
				EnableLogging: true,
			}
			store, err := NewObservableStoreWithOptions[string, string](options)
		...
		Convey("条件设置操作", func() {
			options := &ObservableStoreOptions{
				...
				Name:          randomName("test_store_set_condition"),
				EnableMetrics: true,
				EnableLogging: true,
			}
			store, err := NewObservableStoreWithOptions[string, string](options)
...
func TestObservableStoreGet(t *testing.T) {
	Convey("ObservableStore.Get", t, func() {
		options := &ObservableStoreOptions{
			...
			Name:          randomName("test_store_get"),
			EnableMetrics: true,
			EnableLogging: false,
		}
		store, err := NewObservableStoreWithOptions[string, string](options)
...
func TestObservableStoreDel(t *testing.T) {
	Convey("ObservableStore.Del", t, func() {
		options := &ObservableStoreOptions{
			...
			Name:          randomName("test_store_del"),
			EnableMetrics: true,
			EnableLogging: false,
		}
		store, err := NewObservableStoreWithOptions[string, string](options)
...
func TestObservableStoreBatchSet(t *testing.T) {
	Convey("ObservableStore.BatchSet", t, func() {
		options := &ObservableStoreOptions{
			...
			Name:          randomName("test_store_batch_set"),
			EnableMetrics: true,
			EnableLogging: false,
		}
		store, err := NewObservableStoreWithOptions[string, string](options)
...
func TestObservableStoreBatchGet(t *testing.T) {
	Convey("ObservableStore.BatchGet", t, func() {
		options := &ObservableStoreOptions{
			...
			Name:          randomName("test_store_batch_get"),
			EnableMetrics: true,
			EnableLogging: false,
		}
		store, err := NewObservableStoreWithOptions[string, string](options)
...
func TestObservableStoreBatchDel(t *testing.T) {
	Convey("ObservableStore.BatchDel", t, func() {
		options := &ObservableStoreOptions{
			...
			Name:          randomName("test_store_batch_del"),
			EnableMetrics: true,
			EnableLogging: false,
		}
		store, err := NewObservableStoreWithOptions[string, string](options)
...
func TestObservableStoreClose(t *testing.T) {
	Convey("ObservableStore.Close", t, func() {
		options := &ObservableStoreOptions{
			...
			Name:          randomName("test_store_close"),
			EnableMetrics: true,
			EnableLogging: false,
		}
		store, err := NewObservableStoreWithOptions[string, string](options)
	...
	Convey("ObservableStore观测功能", t, func() {
		Convey("禁用所有观测功能", func() {
			options := &ObservableStoreOptions{
				...
				Name:          randomName("test_store_no_observe"),
				EnableMetrics: false,
				EnableLogging: false,
				EnableTracing: false,
			}
		...
		Convey("只启用指标收集", func() {
			options := &ObservableStoreOptions{
				...
				Name:          randomName("metrics_only_store"),
				EnableMetrics: true,
				EnableLogging: false,
				EnableTracing: false,
			}
		...
		Convey("同时启用多种观测功能", func() {
			options := &ObservableStoreOptions{
				...
				Name:          randomName("full_observable_store"),
				EnableMetrics: true,
				EnableLogging: true,
				EnableTracing: true,
			}
